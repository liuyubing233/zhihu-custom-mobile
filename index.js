...
// @version      2.2.1
// @description  知乎修改器的移动版：首页可持续加载内容，回答可以查看全部回答和评论，文章可以查看全部评论，去除禁止复制的限制，列表标题类别显示功能设置，收起按钮悬浮设置，列表、问题详情、回答、文章内容置顶创建和修改时间设置，一键获取内容链接设置，问题详情添加查看问题日志按钮，自定义样式，隐藏模块，缓存列表和浏览历史记录等功能。
