  ...
  var myListenAnswer = {
    ...
    init: async function() {
      ...
      for (let i = 0, len = nodeAnswers.length; i < len; i++) {
        ...
        const nodeRichInner = nodeItem.querySelector(".RichContent-inner");
