...
const myBackground = {
  ...
  dark: function (darkKey: EThemeDark) {
    ...
    const linkText =
      ...
      `,.css-b7erz1,.css-1vbwaf6,.css-1jj6qre,.css-jf1cpf` +
  ...
  cssNamesBackground1:
    ...
    `,.editable,textarea.zg-form-text-input,.zg-form-text-input>textarea,.ac-active` +
    `,.css-d1dtt9,.css-k8i00s,.css-41c1px,.zm-editable-editor-field-wrap,.zu-question-suggest-topic-input,.zg-form-text-input,.zg-form-select`,
  /** 使用背景色2的元素名称 */
  cssNamesBackground2:
    ...
    `,.css-4r7szo,.css-vkey2q,.css-ugzr12,.css-6v1k3,.css-1xj1964,.css-ggid2,.css-rhbxt0,.css-1j23ebo,.css-7wvdjh`,
  /** 背景色透明的元素名称 */
